...
<div class="contentLearning">
    <?php if(($lstLatestPosts = get_latest_posts())): ?>
        <div class="dimensionalLearning">
            <h3 class="titleCoporate" id="titleHome">Sự kiện</h3>
    ...
    <div class="dimensionalVideo">
        <?php if(($videos_box = ot_get_option(THEME_PREFIX . 'TZHomePage_videos_box'))): ?>
            <h3 class="titleHome">
                ...
                <div class="viewDetailNews"><a href="<?php echo ot_get_option(THEME_PREFIX . '_TZHomePage_videos_more_url'); ?>" class="aDetailNews">Xem thêm</a></div>
            </h3>
        ...
        <?php if(($gallery_box = ot_get_option(THEME_PREFIX . 'TZHomePage_gallery_box'))): ?>
            <h3 class="titleHome">
                <div class="titleNameHome">Hình ảnh</div>
                <div class="viewDetailNews"><a href="<?php echo ot_get_option(THEME_PREFIX . '_TZHomePage_gallery_more_url'); ?>" class="aDetailNews">Xem thêm</a></div>
            </h3>
            <ul class="ulVideoHome">
