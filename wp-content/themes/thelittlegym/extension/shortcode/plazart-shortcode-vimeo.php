...
<head>
  <title><?php echo __('Vimeo Shortcode', TEXT_DOMAIN); ?></title>
  ...
  <div id="shortcode-column">
    <div class="shortcode-content">
      <div class="heading-title">
        <?php echo __('Vimeo Video ID', TEXT_DOMAIN); ?>
      </div><!-- end:heading-title -->
      <div class="shorcode-content-inner">
          <input id="youtube_id" type="text" value="" name="text" placeholder="ID" class="vimeo-attrs"/>
          <span class="shortcode-eg">Eg: 1174512</span>
          <input id="youtube_width" name="width" type="text" value="" placeholder="Width" class="vimeo-attrs"/>
          <span class="shortcode-eg"></span>
          <input id="youtube_height" type="text" name="height" value="" placeholder="Height" class="vimeo-attrs"/>
          <span class="shortcode-eg"></span>
    ...
    <div class="shortcode-content">
      ...
      <div class="shortcode-preview">
        <div class="shortcode-preview-inner">
          <code>
            <span id="shortcode-preview-f">[vimeo]</span>
            <span id="shortcode-preview-m"> </span>
            <span id="shortcode-preview-l">[/vimeo]</span>
          </code>
...
<script type="text/javascript">
  ...
  jQuery(function () {
    "use strict";
    jQuery('.vimeo-attrs').bind('keyup change paste', function () {
      ...
      if (String(ele_name) === 'text') {
        ...
        var options = [];
        jQuery('.vimeo-attrs').each(function () {
        ...
        preview_code = '[vimeo' + (options.length ? ' ' + options.join(' ') : '') + ']';
      }
