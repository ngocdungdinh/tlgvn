                                                                                            ...
                                                                                            <table class="ms-sbtable ms-sbtable-ex" border="0">
                                                                                                <tr class="ms-sbrow">
                                                                                                    <td class="ms-sbcell">
                                                                                                        ...
                                                                                                        <input name="s" id="s" type="text" maxlength="200" accesskey="S" title="Enter search words" class="ms-sbplain" alt="Enter search words" placeholder="Enter search words" style="width:170px;" />
                                                                                                    </td>
